...
for (const marker of ["WASD", "interaction-prompt", "evidence-count", "EXHIBITION MAP", "Cánh cửa cuối", "quit-button", "quit-screen", "☭", "drawHammerSickle", "ENTER GATE", "EXIT / LOCKED", "TƯ LIỆU SẢN XUẤT", "CÁCH MẠNG XÃ HỘI"]) assert(html.includes(marker) || app.includes(marker), `Missing gameplay/theme marker: ${marker}`);
