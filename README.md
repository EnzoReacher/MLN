...
Không gian cũng có hai chậu cây low-poly và hai NPC ambient trong mỗi phòng: một khách tham quan đứng chỉ về tranh, một người đi chậm qua lại trên tuyến riêng. Đây chỉ là lớp trang trí, không chiếm phím `E`, không chặn đường và không dùng pathfinding, physics, spotlight hay shadow động.
